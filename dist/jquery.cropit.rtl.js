	...
	var Cropit = (function () {
	  ...
	  _createClass(Cropit, [{
	      ...
	      if (!this.options.freeMove) {
	        if (RTL) {
	        	...
	        	if (this.imageWidth * this.zoom >= this.previewSize.width) {
	        	  ...
	        	  ret.x = Math.min(0, Math.max(ret.x, this.imageWidth * this.zoom) - this.previewSize.width);
	        	}
	        } else {
	        	if (this.imageWidth * this.zoom >= this.previewSize.width) {
	    ...
	    value: function getCroppedImageData(exportOptions) {
	      ...
	      canvasContext.translate(last_rotatedOffset_x * exportZoom, this.rotatedOffset.y * exportZoom);
